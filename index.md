      ...
      <div class="row justify-content-md-center">
        <div class="col-md">
          ...
          <ul>
            ...
            <li class="one"><strong>Cancelled Events List:</strong> We are contributing to a database of all of the cancelled, postponed, or virtual-only conferences affected by coronavirus. Take a look at the events <a href="https://airtable.com/shrETNURgXNrGWbd8/tblc49hMMykARebo8?blocks=hide" target="_blank">here</a>.</li>
          </ul>
        </div>
        <div class="col-md-6 section-photo d-none d-md-block">
